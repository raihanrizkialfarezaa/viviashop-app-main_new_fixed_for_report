...
@section('content')
        ...
        <div class="slider-area">
            <div class="slider-active owl-carousel">
                @foreach($slides as $slide)
                    <div class="single-slider-4 slider-height-6 bg-img" style="background-image: url({{ $slide->image_url }})">
                        <div class="container">
                            <div class="row">
    ...
    <!-- products -->
    @if ($products)
	<div class="popular-product-area wrapper-padding-3 pt-115 pb-115" style="margin-top: 200px">
