          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <i class="fa fa-plus-circle mr-2"></i>Tambah Slide Baru
                </h3>
              ...
              <div class="card-body">
                <form method="post" action="{{ route('admin.slides.store') }}" enctype="multipart/form-data" id="slide-form">
                    @csrf
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          ...
                          <small class="form-text text-muted mt-2">
                            ...
                            Dimensi rekomendasi: <strong>1920x600px</strong> untuk tampilan optimal.
                          </small>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-control @error('status') is-invalid @enderror" name="status" id="status">
                            @foreach($statuses as $value => $status)
                              <option {{ old('status') == $value ? 'selected' : null }} value="{{ $value }}">
                                {{ $status }}
                              </option>
                            @endforeach
                          </select>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10 offset-sm-2">
                          <button type="submit" class="btn btn-success px-4">
                            <i class="fa fa-save mr-1"></i> Simpan Slide
                          </button>
